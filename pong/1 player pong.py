...
def computer_move():
    if paddle_right.turtle.ycor() < ball.turtle.ycor() and paddle_right.turtle.ycor() < 260:
        paddle_right.turtle.sety(paddle_right.turtle.ycor() + 10)
...
pen.hideturtle()
pen.goto(0, 260)
pen.write(f"Player A:{left_score} Computer:{right_score}", align="center", font=("Courier", 24, "bold"))
...
window.listen()
window.onkeypress(paddle_left_up, "Up")
window.onkeypress(paddle_left_down, "Down")
